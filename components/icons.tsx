...
export const LeafIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M9 18c6.218 0 10.5-3.288 11-12V4h-4.014c-9 0-9.986 7.014-9.986 9c0 2.418 1.582 4 4 4h4" />
    </svg>
);
...
export const BotMessageSquareIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M2 12h2"></path><path d="M9 12h2"></path><path d="M16 12h2"></path>
    </svg>
);
...
export const UsersRoundIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M12 3a1 1 0 0 1 1 1v6a1 1 0 0 1-2 0V4a1 1 0 0 1 1-1z"></path>
        <path d="M20.6 8.2a1 1 0 0 0-1.1.2l-4.2 3.5a1 1 0 0 0 0 1.6l4.2 3.5a1 1 0 0 0 1.6-.6V9a1 1 0 0 0-.5-.8z"></path>
        <path d="M3.4 8.2a1 1 0 0 1 1.1.2l4.2 3.5a1 1 0 0 1 0 1.6l-4.2 3.5a1 1 0 0 1-1.6-.6V9a1 1 0 0 1 .5-.8z"></path>
    </svg>
);
...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L10 12l-2 2 2.293 2.293a1 1 0 010 1.414L5 21m14-16l-2.293 2.293a1 1 0 000 1.414L14 12l2 2-2.293 2.293a1 1 0 000 1.414L19 21" />
    </svg>
);
...
export const MapViewIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m0 0l-3.75-3.75M9 15l3.75-3.75M9 15v2.25m-3.75-6.75v6.75m6.75-6.75v6.75m-3.75-6.75h.008v.008h-.008v-.008zm3.75 0h.008v.008h-.008v-.008zm-3.75 3.75h.008v.008h-.008v-.008zm3.75 0h.008v.008h-.008v-.008z" />
  </svg>
);

export const SaplingListIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const ChatBubbleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537V17.5c0 .621-.504 1.125-1.125 1.125H9.75c-1.136 0-2.1-.847-2.193-1.98l-.537-3.722c-.088-.621.416-1.125 1.038-1.125h.5c.621 0 1.125.504 1.125 1.125v.528c0 .621.504 1.125 1.125 1.125h.528c.621 0 1.125-.504 1.125-1.125v-2.072c0-.621-.504-1.125-1.125-1.125H9.25c-.621 0-1.125-.504-1.125-1.125v-.528c0-.621-.504-1.125-1.125-1.125H6.25c-.621 0-1.125.504-1.125 1.125v.528c0 .621.504 1.125 1.125 1.125h.5c.621 0 1.125.504 1.125 1.125v.528c0 .621.504 1.125 1.125 1.125h.528c.621 0 1.125.504 1.125 1.125v.528" />
    </svg>
);
...
export const TreeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 22v-8" />
        <path d="M12 14l-4-4-2 2" />
        <path d="M12 14l4-4 2 2" />
        <path d="M12 14l-4 4-2-2" />
        <path d="M12 14l4 4 2-2" />
        <path d="M12 4a2 2 0 0 0-2 2v4a2 2 0 0 0 4 0V6a2 2 0 0 0-2-2z" />
    </svg>
);
...
export const FilterXIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M13.013 3H2.997a1 1 0 0 0-1 1v2.586a1 1 0 0 0 .293.707l5.414 5.414a1 1 0 0 1 .293.707V19l4-4v-4.586a1 1 0 0 0-.293-.707l-2.707-2.707"></path>
